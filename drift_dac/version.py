# *- encoding: utf-8 -*-
"""
drift_dac version, required package versions, and utilities for checking
"""
    ...
    for package_name, metadata in DEPENDENCIES_METADATA:
        ...
        try:
            ...
            user_friendly_info = (
                ...
                'Please install it properly to use emu{1}.'.format(
        ...
        if version_too_old:
            message = (
                ...
                'is required to use emu{import_module}. '
